...
public class LemonAcidModel : PageModel
{
    ...
    public LemonAcidModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        ...
        Chart = _chartsHelper.GetChart(Product.LemonAcid);

...
public class Polysorbate80Model : PageModel
{
    ...
    public Polysorbate80Model(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.Polysorbate80);

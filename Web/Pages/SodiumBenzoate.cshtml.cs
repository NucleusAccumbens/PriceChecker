...
public class SodiumBenzoateModel : PageModel
{
    ...
    public SodiumBenzoateModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.SodiumBenzoate);

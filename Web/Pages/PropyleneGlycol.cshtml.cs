...
public class PropyleneGlycolModel : PageModel
{
    ...
    public PropyleneGlycolModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.PropyleneGlycol);

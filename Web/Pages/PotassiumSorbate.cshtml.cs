...
public class PotassiumSorbateModel : PageModel
{
    ...
    public PotassiumSorbateModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.PotassiumSorbate);

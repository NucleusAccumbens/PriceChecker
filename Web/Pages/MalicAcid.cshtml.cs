...
namespace Web.Pages
{
    public class MalicAcidModel : PageModel
    {
        ...
        public MalicAcidModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
        {
        ...
        public void OnGet()
        {
            Chart = _chartsHelper.GetChart(Product.MalicAcid);

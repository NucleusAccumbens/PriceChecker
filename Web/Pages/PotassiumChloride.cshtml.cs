...
public class PotassiumChlorideModel : PageModel
{
    ...
    public PotassiumChlorideModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.PotassiumChloride);

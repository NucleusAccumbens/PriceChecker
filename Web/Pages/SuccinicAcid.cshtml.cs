...
public class SuccinicAcidModel : PageModel
{
    ...
    public SuccinicAcidModel(IGetPricesQuery getPricesQuery, IMemoryCachService memoryCachService)
    {
    ...
    public void OnGet()
    {
        Chart = _chartsHelper.GetChart(Product.SuccinicAcid);
